...
namespace Pinterest.MessageBrokers.RabbitMQ.Implementations;
    ...
    : IMessageProducer, IAsyncDisposable
{
    ...
    public async Task SendAsync<TMessage>(string publishingPath, TMessage message) where TMessage : MessageBase
    {
